...
# Standalone Hugging Face remote-code adaptation generated from the installed transformers==5.11.0 source; package-relative imports were rewritten.
...
from transformers.utils.generic import TransformersKwargs, maybe_autocast, merge_with_config_defaults
...
Olmo3Model.register_for_auto_class("AutoModel")
Olmo3ForCausalLM.register_for_auto_class("AutoModelForCausalLM")
